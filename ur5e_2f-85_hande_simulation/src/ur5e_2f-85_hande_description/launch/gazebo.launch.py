...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="ur5e_2f-85_hande_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="ur5e_2f-85_hande_config.urdf.xacro",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution([
                FindPackageShare("ur5e_2f-85_hande_description"),
                "rviz",
                "ur5e_2f-85_hande.rviz"
            ]),
    ...
    gripper_2f_85_description_path = get_package_share_directory("robotiq_description")
    hande_gripper_description_path = get_package_share_directory("robotiq_hande_description")
    ...
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value=[
            ...
            ":",
            str(Path(gripper_2f_85_description_path).parent.resolve()),
            ":",
            str(Path(hande_gripper_description_path).parent.resolve()),
        ],
    )
    ...
    custom_world_path = os.path.join(
        get_package_share_directory("ur5e_2f-85_hande_description"),
        "worlds",
        "custom_world.sdf"
    )
