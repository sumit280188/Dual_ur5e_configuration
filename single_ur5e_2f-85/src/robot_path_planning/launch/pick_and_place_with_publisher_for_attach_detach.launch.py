...
def generate_launch_description():
    ...
    pick_and_place_with_publisher_for_attach_detach_node = Node(
        package="robot_path_planning",
        executable="pick_and_place_with_publisher_for_attach_detach",
        output="screen",
        emulate_tty=True,
        parameters=[
    ...
    return LaunchDescription([pick_and_place_with_publisher_for_attach_detach_node,
