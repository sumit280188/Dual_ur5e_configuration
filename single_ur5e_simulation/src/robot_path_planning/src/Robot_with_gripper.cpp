...
int main(int argc, char **argv)
{
    ...
    move_group_gripper.setMaxVelocityScalingFactor(1.0);    // Adjust velocity as needed
    move_group_gripper.setJointValueTarget("robotiq_85_left_knuckle_joint", 0.8); // Adjust joint value as needed
    ...
    move_group_gripper.setMaxVelocityScalingFactor(1.0);   // Adjust velocity as needed
    move_group_gripper.setJointValueTarget("robotiq_85_left_knuckle_joint", 0.0); // Adjust joint value as needed
    if (move_group_gripper.move() != moveit::core::MoveItErrorCode::SUCCESS)
    {
