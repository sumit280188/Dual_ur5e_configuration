...
private:
    ...
    bool moveToPregraspPosition()
    {
        ...
        target_pose.position.z = 0.510; //changed from 520 to 525
    ...
    bool movingToDropLocation()
    {
        ...
        // At time 201.734000000 tool0
        // - Translation: [-0.492, -0.084, 0.534]
        // - Rotation: in Quaternion [0.509, -0.491, -0.494, 0.506]
        // - Rotation: in RPY (radian) [1.571, 0.006, -1.541]
        // - Rotation: in RPY (degree) [90.002, 0.369, -88.298]
        // - Matrix:
        //   0.030  0.000 -1.000 -0.492
        //  -1.000 -0.006 -0.030 -0.084
        //  -0.006  1.000 -0.000  0.534
        //   0.000  0.000  0.000  1.000
        
        // At time 227.603000000 right_finger_tip
        // - Translation: [-0.603, -0.139, 0.538]
        // - Rotation: in Quaternion [0.507, -0.491, -0.499, 0.503]
        // - Rotation: in RPY (radian) [1.567, 0.012, -1.551]
        // - Rotation: in RPY (degree) [89.794, 0.686, -88.854]
        // - Matrix:
        //   0.020  0.004 -1.000 -0.603
        //  -1.000 -0.012 -0.020 -0.139
        //  -0.012  1.000  0.004  0.538
        //   0.000  0.000  0.000  1.000
